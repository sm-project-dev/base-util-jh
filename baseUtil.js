 ...
 * @param {number} the number to conver to hex
 * @return {string} the hex representation of the provided number
 */
 ...
 * @param {string} color1 the first color, hex (ie: #000000)
 * @param {string} color2 the second color, hex (ie: #ffffff)
 * @param {number=} percentage the distance from the first color, as a decimal between 0 and 1 (ie: 0.5)
 * @return {string} the third color, hex, represenatation of the blend between color1 and color2 at the given percentage
 */
